...
6. Generate `docs/_meta/documentation-map.json`, `state.json`, `docs/_meta/coverage.md`, and `docs/index.md` when missing, including the language decision. Register the index as `documentation.index` and validate its `_meta/coverage.md` link.
